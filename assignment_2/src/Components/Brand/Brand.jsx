...
export default function Brand() {
  ...
  function getData() {
    return axios.get(`${process.env.REACT_APP_BaseUrl}/api/brand`);
  }

  const { data, isLoading, isError } = useQuery("brandDetails", getData)
    ...
    <>
      ...
      <div className="container">
        <div className="row g-3">
          <h1 className="p-2 text-center my-3">ALL Brands</h1>
          {isLoading ? (
